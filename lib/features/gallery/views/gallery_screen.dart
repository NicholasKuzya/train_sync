...
class _GalleryScreenState extends State<GalleryScreen> {
  ...
  Future<void> _fetchExercises(String token, {String? category}) async {
    final Uri url = category != null
        ? Uri.parse(
            'http://192.168.0.106:3000/api/trainer/exercises?categoryId=$category')
  ...
  Future<void> _fetchSets(String token, {String? category}) async {
    final Uri url = category != null
        ? Uri.parse(
            'http://192.168.0.106:3000/api/trainer/set?categoryId=$category')
        : Uri.parse('http://192.168.0.106:3000/api/trainer/set');
