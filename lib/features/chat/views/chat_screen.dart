...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    socket = IO.io('http://training-sync.com', <String, dynamic>{
  ...
  Future<void> _getSenderId() async {
    ...
    var url = Uri.parse('https://training-sync.com/api/$role/get');
  ...
  Future<void> _getCompanionData() async {
    ...
    var url = Uri.parse(
        'https://training-sync.com/api/$role/get/${widget.companionId}');
    var response = await http.post(
      url,
      headers: {'authorization': '$token'},
    );
  ...
  Future<void> _fetchChatMessages() async {
    try {
      String? token = await TokenManager.getToken();
      var url = Uri.parse('https://training-sync.com/api/chat/messages');
      var response = await http.post(
        url,
        headers: {
          'authorization': '$token',
