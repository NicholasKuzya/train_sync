...
class _TrainingPlanScreenState extends State<TrainingPlanScreen> {
  ...
  void _fetchTrainings() async {
    ...
    var url = Uri.parse('https://training-sync.com/api/student/training/get');
  ...
  void _addTraining() async {
    ...
    String url = 'https://training-sync.com/api/student/training/add';
    if (_selectedTrainings.isNotEmpty && _selectedTrainings.any((training) => training['dates'] != null && training['dates'].isNotEmpty && isSameDay(DateTime.parse(training['dates'][0]), _selectedDay))) {
      ...
      url = 'https://training-sync.com/api/student/training/update/${_selectedTrainings[0]['_id']}';
    }
  ...
  Future<void> _fetchExercises() async {
    ...
    final Uri url = Uri.parse(
        'https://training-sync.com/api/trainer/exercises?categoryId=');
  ...
  Future<void> _fetchSets() async {
    String? token = await TokenManager.getToken();
    final Uri url = Uri.parse('https://training-sync.com/api/trainer/set');
    final response = await http.get(
      url,
      headers: {'authorization': token!},
    );
