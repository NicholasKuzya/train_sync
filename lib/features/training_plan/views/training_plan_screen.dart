...
class _TrainingPlanScreenState extends State<TrainingPlanScreen> {
  ...
  void _fetchTrainings() async {
    ...
    var url = Uri.parse('http://192.168.0.105:4000/api/student/training/get');
  ...
  Future<void> _fetchExercises() async {
    ...
    final Uri url = Uri.parse(
        'http://192.168.0.105:4000/api/trainer/exercises?categoryId=');
  ...
  Future<void> _fetchSets() async {
    String? token = await TokenManager.getToken();
    final Uri url = Uri.parse('http://192.168.0.105:4000/api/trainer/set');
    final response = await http.get(
      url,
      headers: {'authorization': token!},
    );
