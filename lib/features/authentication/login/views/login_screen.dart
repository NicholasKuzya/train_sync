...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    String url = 'http://192.168.0.105:4000/api/$_userType/login';
  ...
  Future<void> _sendResetCode() async {
    ...
    String url = 'http://192.168.0.105:4000/api/$_userType/reset/code';
  ...
  Future<void> _resetPassword() async {
    ...
    String url = 'http://192.168.0.105:4000/api/$_userType/reset/pass';
