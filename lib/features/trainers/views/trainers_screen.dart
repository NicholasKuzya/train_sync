...
class _TrainerInputScreenState extends State<TrainerInputScreen> {
  ...
  Future<void> _fetchTrainers() async {
    ...
    final response = await http.get(
      Uri.parse('https://training-sync.com/api/trainer/get/all?country=$_selectedCountry&city=$_selectedCity&district=$_selectedDistrict&sortBy=$_selectedSortBy&searchQuery=$_searchQuery'),
      headers: {
        'authorization': token,
  ...
  Future<void> _sendTrainingRequest(String trainerId, String message) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://training-sync.com/api/student/training/send-request'),
        headers: {
          'authorization': token,
          'Content-Type': 'application/json'
        },
                            ...
                            CircleAvatar(
                              ...
                              child: ClipOval(
                                child: trainer.avatarUrl.isNotEmpty && trainer.avatarUrl != ""
                                    ? Image.network(
                                  'https://training-sync.com/api/uploads/avatar/${trainer.avatarUrl}',
                                  fit: BoxFit.cover,
                              ...
                              onPressed: () async {
                                try {
                                  ...
                                  var studentResponse = await http.post(
                                    Uri.parse('https://training-sync.com/api/student/get'),
                                  ...
                                  if (studentId != null) {
                                    ...
                                    var createChatResponse = await http.post(
                                      Uri.parse('https://training-sync.com/api/chat/create'),
